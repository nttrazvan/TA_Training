...
Feature: Feature to test tables, links and others
  ...
  Scenario Outline: This is a scenario outline that tests the content of a table, the buttons and the redirection of links
    ...
    And The table content should be "<Col1>" "<Col2>" "<Col3>" "<Col4>" "<Col5>" "<Col6>"
    ...
    Examples:
      | Col1     | Col2      | Col3      | Col4        | Col5          | Col6      | Headers |
      | Iuvaret0 | Apeirian0 | Adipisci0 | Definiebas0 | Consequuntur0 | Phaedrum0 | Lorem   |
      | Iuvaret1 | Apeirian1 | Adipisci1 | Definiebas1 | Consequuntur1 | Phaedrum1 | Ipsum   |
      | Iuvaret2 | Apeirian2 | Adipisci2 | Definiebas2 | Consequuntur2 | Phaedrum2 | Dolor   |
      | Iuvaret3 | Apeirian3 | Adipisci3 | Definiebas3 | Consequuntur3 | Phaedrum3 | Sit     |
      | Iuvaret4 | Apeirian4 | Adipisci4 | Definiebas4 | Consequuntur4 | Phaedrum4 | Amet    |
      | Iuvaret5 | Apeirian5 | Adipisci5 | Definiebas5 | Consequuntur5 | Phaedrum5 | Diceret |
      | Iuvaret6 | Apeirian6 | Adipisci6 | Definiebas6 | Consequuntur6 | Phaedrum6 | Action  |
